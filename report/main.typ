...
Sections~#ref(<gen_inst>, supplement: none), #ref(<headings>, supplement: none), and #ref(<others>, supplement: none) below.
...
#figure(
  ...
  table(
    ...
    midrule, [Dendrite], [Input terminal ],
    [$~100$], [Axon    ], [Output terminal],
    [$~10$], [Soma    ], [Cell body      ],
    [up to $10^6$], botrule,

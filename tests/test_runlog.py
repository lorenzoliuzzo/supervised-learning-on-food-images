...
def test_save_writes_history_and_metadata(tmp_path: pathlib.Path) -> None:
    ...
    run.record(epoch=0, train_loss=5.0, train_acc1=1.0, train_acc5=5.0,
               val_acc1=0.5, val_acc5=3.0)
    run.record(epoch=1, train_loss=4.5, train_acc1=2.0, train_acc5=7.0,
               val_acc1=1.0, val_acc5=4.0)
    ...
    assert payload["history"][1] == {
        "epoch": 1, "train_loss": 4.5, "train_acc1": 2.0, "train_acc5": 7.0,
        "val_acc1": 1.0, "val_acc5": 4.0,
    }
